<template>
    <div class="main-content">
      ...
      <div class="sub-section">
        ...
        <div class="right-part">
             ...
             <form class="form-white" @submit.prevent>
                ...
                <p class="para-detail">Enter the details for the GreenHouse client for us to <br/>
                 ...
                 <input class="width" v-model="apiKey" placeholder="Enter API Key " type="text" @keyup="validateApiKey">
                 ...
                 <input class="width" type="text" placeholder="Enter Lever API Key" v-model="leverKey" @keyup="validateLeverKey">
                 ...
                 <input class="width" type="email"> <button>Validate</button> <br/>
                 ...
                 <input class="width" type="text" > <br/>
    ...
    <div class="check-box-right">
        ...
        <label class="box" for="other">other</label>
              ...
              <br/>
                <div>
                    <button @click="addClient" class="get-button">Get Started</button>
                </div>
